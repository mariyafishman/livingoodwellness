...
function unsplash(id: string, width = 1400): string {
  return `https://images.unsplash.com/${id}?auto=format&fit=crop&w=${width}&q=75`;
}

export const photos = {
  hero: {
    src: unsplash('photo-1519823551278-64ac92734fb1', 1600),
  ...
  hands: {
    ...
    alt: 'A hand massage on a soft towel',
    credit: 'THLT LCX',
    creditUrl: 'https://unsplash.com/photos/ubeslMfS1lk'
  },
  seniors: {
    src: unsplash('photo-1702648159899-0eb73a9f3452', 1000),
