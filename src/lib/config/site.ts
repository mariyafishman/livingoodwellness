export const site = {
  ...
  /** Canonical site URL. Assumed until the domain is confirmed. */
  ...
  mapsUrl: 'https://www.google.com/maps/search/?api=1&query=157+Marlboro+Street%2C+Hudson%2C+MA+01749',
  ...
  hoursSummary: 'Mon–Fri, by appointment. Saturdays by arrangement.',
