...
- Manrope 400–800 for body and confident, tightly tracked headings. Lora italic 400–500 is reserved for personal voice in quotes, Mariya’s handwritten note, and the footer tagline; do not italicize isolated heading words. Desktop display 106px, section headings 56px; mobile 66px and 40px. Fonts currently load through Google Fonts.
...
- Home follows the chosen artboard: butter hero with Mariya's real portrait in an irregular lilac collage, solid rounded butterfly, pastel modality and rate cards without decorative numbering, BEMER directly after rates, a lilac bio, then a deep green visit panel.
- Service cards and visit steps do not use decorative numbers or stars. The inline SVG and favicon use the selected solid butterfly as a placeholder. The favicon repeats the approved brand colors because it is a standalone asset.
